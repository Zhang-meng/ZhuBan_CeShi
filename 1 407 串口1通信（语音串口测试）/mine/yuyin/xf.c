...
void rensheng(u8 num)
{
	switch(num)
	{
		case 0:PrintCom(XIAO_YAN,9); 	delay_ms(10);	speek("你好！我是小燕，很高兴为您服务");break;
		case 1:PrintCom(XU_JIU,10);		delay_ms(10);	speek("你好！我是许久，很高兴为您服务！");break;
		case 2:PrintCom(YU_DUO,10);		delay_ms(10);	speek("你好！我是许多，很高兴为您服务");break;
		case 3:PrintCom(XIAO_PING,10);delay_ms(10);	speek("你好！我是小萍，很高兴为您服务");break;
		case 4:PrintCom(LAO_YA,10);		delay_ms(10);	speek("你好！我是唐老鸭，很高兴为您服务");break;
		case 5:PrintCom(XIAO_BAO,10);	delay_ms(10);	speek("你好！我是唐小宝，很高兴为您服务");break;
	}                                                                         
} 
//音量选择
void yinling(u8 num)
{
	switch(num)
	{
		case 0:PrintCom(YIN_LIANG0,9);delay_ms(10);speek("这是音量为0的感受");break;
		case 1:PrintCom(YIN_LIANG1,9);delay_ms(10);speek("这是音量为1的感受");break;
		case 2:PrintCom(YIN_LIANG2,9);delay_ms(10);speek("这是音量为2的感受");break;
		case 3:PrintCom(YIN_LIANG3,9);delay_ms(10);speek("这是音量为3的感受");break;
		case 4:PrintCom(YIN_LIANG4,9);delay_ms(10);speek("这是音量为4的感受");break;
		case 5:PrintCom(YIN_LIANG5,9);delay_ms(10);speek("这是音量为5的感受");break;
		case 6:PrintCom(YIN_LIANG6,9);delay_ms(10);speek("这是音量为6的感受");break;
		case 7:PrintCom(YIN_LIANG7,9);delay_ms(10);speek("这是音量为7的感受");break;
		case 8:PrintCom(YIN_LIANG8,9);delay_ms(10);speek("这是音量为8的感受");break;
		case 9:PrintCom(YIN_LIANG9,9);delay_ms(10);speek("这是音量为9的感受");break;
	}                                                                        
}                                 
//语速选择
void yusu(u8 num)
{
	switch(num)
	{
		case 0:PrintCom(YIN_SU0,9);delay_ms(10);speek("这是语速为0的感受");break;
		case 1:PrintCom(YIN_SU1,9);delay_ms(10);speek("这是语速为1的感受");break;
		case 2:PrintCom(YIN_SU2,9);delay_ms(10);speek("这是语速为2的感受");break;
		case 3:PrintCom(YIN_SU3,9);delay_ms(10);speek("这是语速为3的感受");break;
		case 4:PrintCom(YIN_SU4,9);delay_ms(10);speek("这是语速为4的感受");break;
		case 5:PrintCom(YIN_SU5,9);delay_ms(10);speek("这是语速为5的感受");break;
		case 6:PrintCom(YIN_SU6,9);delay_ms(10);speek("这是语速为6的感受");break;
		case 7:PrintCom(YIN_SU7,9);delay_ms(10);speek("这是语速为7的感受");break;
		case 8:PrintCom(YIN_SU8,9);delay_ms(10);speek("这是语速为8的感受");break;
		case 9:PrintCom(YIN_SU9,9);delay_ms(10);speek("这是语速为9的感受");break;
	}                                                                         
}
//语调选择
void yudiao(u8 num)
{
	switch(num)
	{
		case 0:PrintCom(YIN_DIAO0,9);delay_ms(10);speek("这是语调为0的感受");break;
		case 1:PrintCom(YIN_DIAO1,9);delay_ms(10);speek("这是语调为1的感受");break;
		case 2:PrintCom(YIN_DIAO2,9);delay_ms(10);speek("这是语调为2的感受");break;
		case 3:PrintCom(YIN_DIAO3,9);delay_ms(10);speek("这是语调为3的感受");break;
		case 4:PrintCom(YIN_DIAO4,9);delay_ms(10);speek("这是语调为4的感受");break;
		case 5:PrintCom(YIN_DIAO5,9);delay_ms(10);speek("这是语调为5的感受");break;
		case 6:PrintCom(YIN_DIAO6,9);delay_ms(10);speek("这是语调为6的感受");break;
		case 7:PrintCom(YIN_DIAO7,9);delay_ms(10);speek("这是语调为7的感受");break;
		case 8:PrintCom(YIN_DIAO8,9);delay_ms(10);speek("这是语调为8的感受");break;
		case 9:PrintCom(YIN_DIAO9,9);delay_ms(10);speek("这是语调为9的感受");break;
	}                                                                         
}
